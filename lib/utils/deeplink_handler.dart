...
abstract class DeeplinkHandler {
  static void openPage(BuildContext? context, String url) async {
    ...
    // /checkout
    switch (route) {
      case ScreenRoutes.userServiceTabsScreen:
        {
          _pushScreen(context, ScreenRoutes.userServiceTabsScreen, args);
        }
        break;
      ...
      case ScreenRoutes.addUserServiceCustomer:
        ...
        break;
      case ScreenRoutes.myAgentListScreen:
        {
          _pushScreen(context, ScreenRoutes.myAgentListScreen, args);
        }
        break;
      default:
