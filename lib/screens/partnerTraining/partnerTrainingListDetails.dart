...
class _ServiceLandingScreenState
  ...
  void didChangeDependencies() {
    args = ModalRoute.of(context)?.settings.arguments ?? widget.args;

    // var enc = JsonEncoder.withIndent("    ");
    // var js = enc.convert(args);
    // debugPrint(js);
...
/*
{
    ...
    "data": {
        "response": {
            "image": "https://www.poornima.edu.in/wp-content/uploads/2020/10/Central-Library.jpg",
            "title": "Basics of Computer Fundamentals",
            ...
            "materials": [
                ...
                {
                    "title": "Learn Web Development and Get Hired in 2023",
                    "description": "Learn Web Development and Get Hired in 2023 | Tanay Pratap Hindi",
                    "duration": "12 weeks",
                    "instructor": "Tanay Pradap",
                    "thumbnail": "https://i.ytimg.com/vi/TLacepiMuqk/maxresdefault.jpg",
                    "logo": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRSrDmV9e39L-T1mHzgBPiD7FrlyVC8-UXSq3rcjnoviQ&s",
                    "action": {
                        "type": "OPEN_PAGE",
                        "data": {
...
{
  "material_data": {
    "title": "How to Become Tata New agent!",
    "instructor": "Acharya Prashant",
    "dateTime": "30 minutes",
    "thumbnail": "https://www.pngitem.com/pimgs/m/255-2550411_404-error-images-free-png-transparent-png.png",
     "logo": "https://www.pngitem.com/pimgs/m/255-2550411_404-error-images-free-png-transparent-png.png",
     "action": {
      "type": "OPEN_VIDEO",
        "data": {
                "url": "https://www.youtube.com/watch?v=c_6jv5X-2h4"
        }
  }
  },
  "material_type": "VIDEO",
