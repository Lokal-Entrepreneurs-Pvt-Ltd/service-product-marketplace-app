...
import 'package:login/screens/MainPage/MainPage.dart';
...
import 'package:login/widgets/UikMembership/MembershipCard.dart';
import 'package:login/widgets/UikPagination/testpagination.dart';
import 'package:login/widgets/apiTest.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        "/": (context) => LoginPage(),//MembershipCard(perks: ["asdfasdf","asdfasdf","asdfasdfasdf"],),
